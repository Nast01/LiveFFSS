...
abstract class $CategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, int? ageMin, int? ageMax});
}
...
class _$CategoryImpl implements _Category {
  const _$CategoryImpl(
      {required this.id, required this.name, this.ageMin, this.ageMax});
  ...
  @override
  String toString() {
    return 'Category(id: $id, name: $name, ageMin: $ageMin, ageMax: $ageMax)';
  }
...
abstract class _Category implements Category {
  const factory _Category(
      ...
      final int? ageMin,
      final int? ageMax}) = _$CategoryImpl;
